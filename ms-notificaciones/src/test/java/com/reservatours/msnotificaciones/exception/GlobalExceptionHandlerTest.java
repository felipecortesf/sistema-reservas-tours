package com.reservatours.msnotificaciones.exception;
...
class GlobalExceptionHandlerTest {
    ...
    void handleValidationErrors_retorna400ConCamposInvalidos() {
        ...
        FieldError fieldError = new FieldError("notificacionDto", "mensaje", "no debe estar vacio");
        ...
        assertEquals("no debe estar vacio", response.getBody().get("mensaje"));
    }
}
