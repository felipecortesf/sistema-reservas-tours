package com.reservatours.msnotificacionespush.exception;
...
class GlobalExceptionHandlerTest {
    ...
    void handleRuntimeException_retorna500() {
        ...
        assertEquals("Error inesperado al guardar", response.getBody().get("error"));
    }
    ...
    void handleValidationErrors_retorna400ConCamposInvalidos() {
        ...
        FieldError fieldError = new FieldError("notificacionPushDto", "titulo", "no debe estar vacio");
        ...
        assertEquals("no debe estar vacio", response.getBody().get("titulo"));
    }
}
